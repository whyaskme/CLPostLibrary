    ...
    public class Utils
    {
            ...
            try
            {
                switch(sGender)
                {
                    case "Female":
                        ...
                        List<Female> myRandomName = _mongoFemaleNameCollection.Find<Female>(s => s._t == sGender).Limit(-1).Skip(randomRecordNumber).ToListAsync<Female>().Result;
                    ...
                    case "Male":
                        ...
                        List<Male> myRandomMaleName = _mongoMaleNameCollection.Find<Male>(s => s._t == sGender).Limit(-1).Skip(randomRecordNumber).ToListAsync<Male>().Result;
        ...
        public string GetRandomLastName()
        {
            ...
            try
            {
                ...
                myRandomName = _mongoLastNameCollection.Find<Last>(s => s._t == "Last").Limit(-1).Skip(randomRecordNumber).ToListAsync<Last>().Result;
        ...
        public string GetRandomStreetName()
        {
            ...
            try
            {
                ...
                // Query random on iGender
                myRandomName = _mongoStreetNameCollection.Find<Street>(s => s._t == "Street").Limit(-1).Skip(randomRecordNumber).ToListAsync<Street>().Result;
        ...
        public string GetRandomCity(ObjectId stateId)
        {
            ...
            try
            {
                ...
                CityNameCount = _mongoCityCollection.Find<City>(s => s.StateId == stateId).ToListAsync<City>().Result.Count();
                ...
                // Query random on iGender
                myRandomName = _mongoCityCollection.Find<City>(s => s.StateId == stateId).Limit(-1).Skip(randomRecordNumber).ToListAsync<City>().Result;
        ...
        public string[] GetRandomState()
        {
            ...
            try
            {
                ...
                // Query random on iGender
                myRandomName = _mongoStateCollection.Find<State>(s => s._t == "State").Limit(-1).Skip(randomRecordNumber).ToListAsync<State>().Result;
        ...
        public ZipCode GetRandomZipCode()
        {
            ...
            try
            {
                ...
                myRandomZipCodes = _mongoZipCodeCollection.Find<ZipCode>(s => s._t == "ZipCode").Limit(-1).Skip(randomRecordNumber).ToListAsync<ZipCode>().Result;
        ...
        public List<State> GetStates()
        {
            ...
            try
            {
                ...
                var stateCollection = _mongoStateCollection.Find<State>(s => s._t == "State").ToListAsync<State>().Result;
        ...
        public ObjectId GetStateIdByName(string stateName)
        {
            ...
            try
            {
                ...
                var stateCollection = _mongoStateCollection.Find<State>(s => s.Name == stateName).ToListAsync<State>().Result;
                foreach (State currentState in stateCollection)
                {
        ...
        public ObjectId GetCityIdByName(string cityName)
        {
            ...
            try
            {
                ...
                var cityCollection = _mongoCityCollection.Find<City>(s => s.Name == cityName).ToListAsync<City>().Result;
        ...
        public State GetStateByAbbr(string stateAbbr)
        {
            ...
            try
            {
                ...
                var stateCollection = _mongoStateCollection.Find<State>(s => s.Abbr == stateAbbr).ToListAsync<State>().Result;
                foreach (State currentState in stateCollection)
                {
        ...
        public string GetStateAbbr(ObjectId stateId)
        {
            ...
            try
            {
                ...
                var stateCollection = _mongoStateCollection.Find<State>(s => s._id == stateId).ToListAsync<State>().Result;
                foreach (State currentState in stateCollection)
                {
                        ...
                        foreach (HtmlNode node in currentItem.ChildNodes)
                        {
                            switch(node.Name.ToLower())
                            {
                                case "h4": // This is the State, get StateId
                                    ...
                                    var stateCollection = _mongoStateCollection.Find<State>(s => s.Name == currentStateName).ToListAsync<State>().Result;
                                    foreach (State currentState in stateCollection)
                                    {
        ...
        public List<City> GetCities(ObjectId stateId)
        {
            ...
            var cityCollection = _mongoCityCollection.Find<City>(s => s.StateId == stateId).ToListAsync<City>().Result;
        ...
        public List<Market> GetMarkets(ObjectId stateId)
        {
            ...
            var marketCollection = _mongoMarketCollection.Find<Market>(s => s.StateId == stateId).ToListAsync<Market>().Result;
        ...
        public Advertisement GetAdvertisement(ObjectId adertisementId)
        {
            ...
            try
            {
                ...
                myAdList = _mongoAdvertisementCollection.Find<Advertisement>(s => s._id == adertisementId).ToListAsync<Advertisement>().Result;
        ...
        public List<Advertisement> GetSampleAdvertisements()
        {
            ...
            try
            {
                ...
                myAdList = _mongoAdvertisementCollection.Find<Advertisement>(s => s._t == "Advertisement").ToListAsync<Advertisement>().Result;
            }
            catch (Exception ex)
            {
                serviceResponse = ex.ToString();
        ...
        public Advertisement GetSampleAdvertisementData(ObjectId adId)
        {
            ...
            try
            {
                ...
                myAdList = _mongoAdvertisementCollection.Find<Advertisement>(s => s._id == adId).ToListAsync<Advertisement>().Result;
        ...
        public string DeleteAdvertisement(ObjectId adertisementId)
        {
            ...
            try
            {
                ...
                foreach (var currentAd in myAdList)
                {
                    ...
                    _mongoAdvertisementCollection.ReplaceOne<Advertisement>(s => s._id == adertisementId, currentAd);
                }
        ...
        public string GetAdCount()
        {
            ...
            try
            {
                ...
                myAds = _mongoAdvertisementCollection.Find<Advertisement>(s => s._t == "Advertisement").ToListAsync<Advertisement>().Result;
        ...
        public Int16 GetEventCount(int eventType)
        {
            ...
            try
            {
                ...
                if (eventType > 0)
                {
                    myEvents = _mongoEventCollection.Find<Event>(s => s.TypeId == eventType).ToListAsync<Event>().Result;
                }
                else
                {
                    myEvents = _mongoEventCollection.Find<Event>(s => s._t == "Event").ToListAsync<Event>().Result;
        ...
        public Event GetEvent(ObjectId eventId)
        {
            ...
            try
            {
                ...
                myEventList = _mongoEventCollection.Find<Event>(s => s._id == eventId).ToListAsync<Event>().Result;
        ...
        public List<Advertisement> GetAllAdvertisements(int recLimit, int pageNumber)
        {
            ...
            try
            {
                ...
                myAds = _mongoAdvertisementCollection.Find<Advertisement>(s => s._t == "Advertisement").Limit(recLimit).Skip(pageNumber).Sort(sort).ToListAsync<Advertisement>().Result;
            }
            catch (Exception ex)
            {
                serviceResponse = ex.ToString();
            ...
            try
            {
                ...
                switch(orderBy)
                {
                    case "Ascending":
                        ...
                        myUsers = _mongoPersonCollection.Find<Person>(s => s._t == "Person").Limit(recLimit).Skip(pageNumber).Sort(sortAsc).ToListAsync<Person>().Result;
                        break;

                    case "Descending":
                        var sortDesc = Builders<Person>.Sort.Descending(sortBy);

                        myUsers = _mongoPersonCollection.Find<Person>(s => s._t == "Person").Limit(recLimit).Skip(pageNumber).Sort(sortDesc).ToListAsync<Person>().Result;
                        break;
                }
            }
            catch (Exception ex)
        ...
        public List<Stats> GetStats()
        {
            ...
            try
            {
                ...
                myStats = _mongoStatsCollection.Find<Stats>(s => s._t == "Stats").ToListAsync<Stats>().Result;
            }
            catch (Exception ex)
            {
                serviceResponse = ex.ToString();
        ...
        public void UpdateStats(string statType, Int64 statValue)
        {
            ...
            try
            {
                ...
                List<Stats> myStats = _mongoStatsCollection.Find<Stats>(s => s._t == "Stats").ToListAsync<Stats>().Result;
        ...
        public string RegisterGmailUserAccount(string userName, string firstName, string lastName, string password)
        {
            ...
            AppsService appService = new AppsService("clposts.com", "clposts81@gmail.com", "13324BossWood");
        ...
        public List<Person> GetUsersWithFilter(string queryType)
        {
            ...
            try
            {
                ...
                {
                    case "marketassigned":
                        myUsers = _mongoPersonCollection.Find<Person>(s => s.Markets[0].Name != "").ToListAsync<Person>().Result;
                        break;
                    ...
                    case "craigslistregistered":
                        myUsers = _mongoPersonCollection.Find<Person>(s => s.AccountCL.IsRegistered == true).ToListAsync<Person>().Result;
                        break;

                    case "craigslistnotregistered":
                        myUsers = _mongoPersonCollection.Find<Person>(s => s.AccountCL.IsRegistered == false).ToListAsync<Person>().Result;
                        break;

                    case "gmailregistered":
                        myUsers = _mongoPersonCollection.Find<Person>(s => s.AccountGmail.IsRegistered == true).ToListAsync<Person>().Result;
                        break;

                    case "gmailnotregistered":
                        myUsers = _mongoPersonCollection.Find<Person>(s => s.AccountGmail.IsRegistered == false).ToListAsync<Person>().Result;
                        break;
                }
            }
            catch (Exception ex)
        ...
        public Int64 GetUserCount(string queryType)
        {
            Int64 userCount = 0;
        ...
        public List<Event> GetAllEvents(int recLimit, int pageNumber, int eventType)
        {
            ...
            try
            {
                ...
                if (eventType > 0)
                {
                    myEvents = _mongoEventCollection.Find<Event>(s => s.TypeId == eventType).Limit(recLimit).Skip(pageNumber).Sort(sort).ToListAsync<Event>().Result;
                }
                else
                {
                    myEvents = _mongoEventCollection.Find<Event>(s => s._t == "Event").Limit(recLimit).Skip(pageNumber).Sort(sort).ToListAsync<Event>().Result;
                }
            }
            catch (Exception ex)
            {
        ...
        public List<Event> GetEventTypes()
        {
            ...
            try
            {
                ...
                myEventTypes = _mongoEventCollection.Find<Event>(s => s._t == "Event").Sort(sort).ToListAsync<Event>().Result;
            }
            catch (Exception ex)
            {
                serviceResponse = ex.ToString();
        ...
        public string GetCityCount()
        {
            ...
            var cityCollection = _mongoCityCollection.Find<City>(s => s._t == "City").ToListAsync<City>().Result;
        ...
        public string GetMarketCount()
        {
            ...
            var marketCollection = _mongoMarketCollection.Find<Market>(s => s._t == "Market").ToListAsync<Market>().Result;
